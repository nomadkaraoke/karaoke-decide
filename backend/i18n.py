...
Usage:
    ...
    message = t(locale, "services.disconnected", service_type="Spotify")
"""
...
def t(locale: str, key: str, **kwargs: Any) -> str:
    ...
    Args:
        ...
        **kwargs: Interpolation variables (e.g., service_type="Spotify")
...
def get_locale_prefix(locale: str) -> str:
    """Get URL locale prefix for frontend URLs."""
    if locale not in SUPPORTED_LOCALES:
        locale = DEFAULT_LOCALE
    return f"/{locale}"
